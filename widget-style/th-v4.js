(function(){
  const ALLOWED = new Set(['dark','solar','sepia','midnight','pink','grey','green','newyear','halloween','summer','marine','winter','christmas','indonesia','china','philippines','africa','japan','india','greece','dota2','csgo','lol','ff','genshin','monsterhunter','80s','90s','vintage','pixel','stars','stars2']);
