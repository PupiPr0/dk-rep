...
Friends.remove = function (profile_id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://sender-server.dkon.app/api/' + options.api_version + '/method/friends.remove',
...
Friends.sendRequest = function (profile_id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://sender-server.dkon.app/api/' + options.api_version + '/method/friends.sendRequest',
...
Friends.acceptRequest = function (id, profile_id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://sender-server.dkon.app/api/' + options.api_version + '/method/friends.acceptRequest',
        data: 'friendId=' + profile_id + "&accessToken=" + account.accessToken + "&accountId=" + account.id,
        dataType: 'json',
        timeout: 30000,
        success: function(response){
...
Friends.rejectRequest = function (id, profile_id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://sender-server.dkon.app/api/' + options.api_version + '/method/friends.rejectRequest',
        data: 'friendId=' + profile_id + "&accessToken=" + account.accessToken + "&accountId=" + account.id,
        dataType: 'json',
        timeout: 30000,
        success: function(response){
