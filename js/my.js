...
$(document).ready(function() {
    ...
    $("#item-image-upload").fileupload({
        ...
        name: 'image',
        url: "https://api.dkon.app/api/" + options.api_version + "/method/items.uploadImg",
        dropZone:  '',
        dataType: 'json',
    ...
    $("#item-video-upload").fileupload({
        formData: {accountId: account.id, accessToken: account.accessToken},
        name: 'image',
        url: "https://api.dkon.app/api/" + options.api_version + "/method/gallery.uploadVideo",
        dropZone:  '',
        dataType: 'json',
        singleFileUploads: true,
        multiple: false,
    ...
    $("#market-item-image-upload").fileupload({
        formData: {accountId: account.id, accessToken: account.accessToken},
        name: 'image',
        url: "https://api.dkon.app/api/" + options.api_version + "/method/market.uploadImg",
        dropZone:  '',
        dataType: 'json',
        singleFileUploads: true,
        multiple: false,
