...
App.hTimer = 0;
App.time_ms = 700; //7000

App.hChatTimer = 0;
App.chat_time_ms = 500; //2000
...
App.run = function() {
    ...
    $.ajax({
        type: "POST",
        url: "https://sender-server.dkon.app/api/" + options.api_version + "/method/account.getSettings",
...
Users.follow = function (group_id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/' + options.api_version + '/method/group.follow',
...
Report.send = function (itemId, itemType, abuseId) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/' + options.api_version + '/method/reports.new',
...
Post.remove = function (itemId, allowRestore) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/v2/method/items.remove',
...
Post.restore = function (itemId) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/v2/method/items.restore',
...
Post.pin = function (itemId) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/v2/method/items.pin',
        data: 'accessToken=' + account.accessToken + "&accountId=" + account.id + "&itemId=" + itemId,
        dataType: 'json',
        timeout: 30000,
        success: function(response) {
...
Item.like = function (itemId, itemType) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/v2/method/likes.like',
...
Group.changePhoto = function(title, accountId, accessToken, groupId) {
    ...
    $.colorbox({width:"450px", href: url, title: title, overlayClose: false, fixed:true, onComplete: function(){
            ...
            $('.cover_input').upload({
                ...
                action: 'https://api.dkon.app/api/v2/method/group.uploadPhoto',
...
Profile.block = function(profile_id) {
    ...
    $.ajax({
        type: 'POST',
        url: "https://api.dkon.app/api/" + options.api_version + "/method/blacklist.add",
...
Profile.unBlock = function(profile_id) {
    ...
    $.ajax({
        type: 'POST',
        url: "https://api.dkon.app/api/" + options.api_version + "/method/blacklist.remove",
        data: "accountId=" + account.id + "&accessToken=" + account.accessToken + "&profileId=" + profile_id,
        dataType: 'json',
        timeout: 30000,
        success: function (response) {
...
Messages.update = function (chat_id, user_id, access_token) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://sender-server.dkon.app/account/ajax_chat_update',
        ...
        success: function(response){
            ...
            App.chat_time_ms = App.chat_time_ms + 100;
...
Comments.remove = function (itemId, itemType) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/'+ options.api_version +'/method/comments.remove',
...
Gallery.add = function (itemImg, itemPreviewImg, itemOriginImg) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/v2/method/gallery.add',
...
Gallery.remove = function (itemId) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://api.dkon.app/api/' + options.api_version + "/method/gallery.remove",
...
Market.newItem = function () {
    ...
    $.ajax({
        type: 'POST',
        url: "https://api.dkon.app/api/" + options.api_version + "/method/market.newItem",
...
Market.deleteItem = function (itemId) {
    ...
    $.ajax({
        type: 'POST',
        url: "https://api.dkon.app/api/" + options.api_version + "/method/market.removeItem",
        data: "accountId=" + account.id + "&accessToken=" + account.accessToken + "&itemId=" + itemId,
        dataType: 'json',
        timeout: 30000,
        success: function(response) {
